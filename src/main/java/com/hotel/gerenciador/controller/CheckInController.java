...
import com.hotel.gerenciador.controller.checkin.CheckInTabController;
import com.hotel.gerenciador.controller.checkin.CheckOutTabController;
...
public class CheckInController extends BaseController {
    ...
    private void initialize() {
        try {
            ...
            FXMLLoader checkInLoader = new FXMLLoader(getClass().getResource("/view/checkin/CheckInTab.fxml"));
            checkInContent.getChildren().add(checkInLoader.load());
            checkInTabController = checkInLoader.getController();

            // Carregar Check-Out Tab
            FXMLLoader checkOutLoader = new FXMLLoader(getClass().getResource("/view/checkin/CheckOutTab.fxml"));
