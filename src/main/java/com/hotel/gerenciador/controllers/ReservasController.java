...
public class ReservasController {
    ...
    private void novaReserva() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/views/NovaReserva.fxml"));
    ...
    private void editarReserva() {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/views/EditarReserva.fxml"));
            Parent root = loader.load();
